...
function ShipmentsView({ wallet, onRefresh, refreshing, shipments }: { wallet: WalletSnapshot | null; onRefresh: () => void; refreshing: boolean; shipments: LiveShipment[] }) {
