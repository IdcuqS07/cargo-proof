...
function ShipmentsView({ wallet, onRefresh, shipments }: { wallet: WalletSnapshot | null; onRefresh: () => void; shipments: LiveShipment[] }) {
...
export default function Home() {
  ...
  const refreshLiveShipments = () => { void loadLiveShipments().then(setLiveShipments).catch(() => setLiveShipments([])); };
